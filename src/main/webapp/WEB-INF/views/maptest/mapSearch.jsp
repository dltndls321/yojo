...
<body>
<div class="map_wrap" >
    <div id="map" style="width:100%;height:100%;position:relative;overflow:hidden; z-index: 0" ></div>
...
var infowindow = new kakao.maps.InfoWindow({zIndex:1,position : iwPosition, 
	content : iwContent });
