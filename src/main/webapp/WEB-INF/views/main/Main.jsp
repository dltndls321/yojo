...
<br>
<input type="button" value="viewAll로 이동" onclick="location.href='http://localhost:8080/index2.do'">
<br>
...
<br>
<input type="button" value="board로 이동" onclick="location.href='http://localhost:8080/board.do'">
</body>
</html>